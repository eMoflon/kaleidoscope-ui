...
public class DeltaUtil {
	...
	public static String createGoodNameToIdentify(EObject eObject) {
		return (getIdentifier(eObject) + "(" + eObject.hashCode() + ")").replace("\"", "'");
	}
	 ...
	 * attribute</li>
	 * <li>any attribute of the EObject, but String attributes are
	 * preferred</li>
	 * </ul>
	 * The identifier ends with " : " followed by the type of the EObject. <br>
	 * Example: A MocaTree Node with the name "foo" will result in "foo : Node"
	 * <br>
